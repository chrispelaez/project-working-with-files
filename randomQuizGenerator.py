...
# Folders for \quizzes and \answers
...
for quizNum in range(5):
    ...
    answerKeyFile = open('./answers/capitolsquiz_answers%s.txt' % (quizNum +1), 'w') # Create 5 quiz files.
    quizFile.write('Name:\n\nDate:\n\nPeriod:\n\n')
...
for questionNum in range(50):
    correctAnswer = capitals[states[questionNum]] # Cylcle through all 50 states.  Creating a question for each.
...
for i in range(4):
    quizFile.write('%s. %s\n' % ('ABCD'[i], answerOptions[i]))     # Generate  question / answer options to the quiz file.
quizFile.write('\n')
