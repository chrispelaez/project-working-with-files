...
for quizNum in range(5):
    quizFile = open('./quizzes/capitolsquiz%s.txt' % (quizNum + 1), 'w')#Generate 5 quiz files.
    answerKeyFile = open('./answers/capitolsquiz_answers%s.txt' % (quizNum +1), 'w')
    quizFile.write('Name:\n\nDate:\n\nPeriod:\n\n')
...
for questionNum in range(50):# Cylcle through all 50 states. Creating different question for each.
...
for i in range(4):# Generate the question / answer options to the quiz file.
